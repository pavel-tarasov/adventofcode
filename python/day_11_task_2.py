class Monkey:
    ...
    def turn(self):
        while len(self.items) != 0:
            ...
            # relief
            final_worry_level = new_worry_level % all_divisors_product
            # check
...
with open("../inputs/day_11.txt") as file:
    while True:
        ...
        all_divisors_product *= test_value_parsed
        # print(number_parsed)
        # print(items_parsed)
        # print(operation_parsed)
        # print(test_value_parsed)
        # print(target_true_parsed)
        # print(target_false_parsed)
        # print()
...
print(f"task 2 result: {inspections_list[0] * inspections_list[1]}")
